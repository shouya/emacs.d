...
(add-to-list 'recentf-exclude (rx (* any) ".org" eol))
...
(set-face-attribute 'default nil
                    :family shou/mono-font :height shou/font-height)
(set-face-attribute 'variable-pitch nil
                    ;; variable pitch font needs to be higher to match the height of mono font
                    :family shou/var-font :height (+ 10 shou/font-height))
#+END_SRC
...
#+begin_src emacs-lisp
(setf
 (alist-get "\\.pdf\\'" org-file-apps) "mupdf %s"
 )
#+end_src
