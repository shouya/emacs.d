...
(use-package minuet
  ...
  :bind
  (:map prog-mode-map
        ("C-c TAB" . minuet-complete-with-minibuffer)
  ...
  (setq minuet-openai-fim-compatible-options
        (-> minuet-openai-fim-compatible-options
            (plist-put :name "Local FIM")
            (plist-put :model "local-fim")
            (plist-put :end-point "http://127.0.0.1:11434/v1/completions")
            ;; (plist-put :end-point "http://127.0.0.1:8012/v1/completions")
            (plist-put :api-key (-const "sk-any"))
            ))
