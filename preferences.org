...
(cond
 ((eq system-type 'gnu/linux)
  ...
  (setq shou/mono-font-rel-height 1.0)
  (setq shou/var-font-rel-height 1.07))
...
(set-face-attribute 'fixed-pitch nil
                    :family shou/mono-font :height shou/mono-font-rel-height)
(set-face-attribute 'variable-pitch nil
                    :family shou/var-font :height shou/var-font-rel-height)
#+END_SRC
...
(use-package apheleia
  ...
  (defun shou/fix-apheleia-messing-up-buffer-by-interruption-mix-process
      (f &rest args)
    (cl-flet ((interrupt-process kill-process))
      (apply f args)))

  (advice-add 'apheleia--make-process :around  #'shou/fix-apheleia-messing-up-buffer-by-interruption-mix-process)
...
(use-package exunit
  :after elixir-mode
  :bind (:map elixir-mode-map
              ("C-c C-t C-s" . exunit-verify-single)
              ("C-c C-t C-t" . exunit-rerun)
  ...
  (defun shou/set-exunit-project-root ()
    (setq-local exunit-project-root (shou/elixir-project-root)))
