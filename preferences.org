...
(use-package copilot
  ...
  (defun shou/advice-mask-copilot (orig-fn &rest args)
    (cl-letf (((symbol-function 'copilot--on-doc-change)
               (lambda (&rest args) nil)))
      (apply orig-fn args)))
  (advice-add 'org-todo :around #'shou/advice-mask-copilot)
...
(use-package chatgpt-shell
  ...
  (chatgpt-shell-model-versions '("gpt-3.5-turbo" "gpt-4"))
  (chatgpt-shell-system-prompts
   '(("General" . "You treat your user's time as precious. Be succinct in responses. You do not repeat obvious things, including his query. You never apologize for confusions to waste his time. You use markdown liberally to structure responses.")
     ("Programming" . "The user is a hacker-programmer. You treat his time as precious. Be succinct in responses. You do not repeat obvious things, including his query. You never apologize for confusions to waste his time. The user knows how to read manuals. Use markdown to structure your responses.")
     ("Book" . "The user is reading a book. The user will send you the portions he's reading. You help the user 1. summarize and 2. explain what the author is talking. Keep your response short (2-3 sentences). You may use markdown to structure your response")
     ))
