...
(use-package proof-general
  ...
  (add-hook 'coq-mode-hook
            (lambda ()
              ...
              (define-abbrev coq-mode-abbrev-table "refl" "reflexivity")
              (define-abbrev coq-mode-abbrev-table "trans" "transitivity")
...
(use-package company-coq
  ...
  (company-coq-disabled-features
   '(alerts ;; disabling it makes evaluation much faster
     code-folding ;; I don't need it. It's pretty annoying and sometimes misbehaves.
     ))
  )
#+end_src
