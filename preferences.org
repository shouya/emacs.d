...
(use-package projectile
  :defines projectile-project-name
  :custom
...
(defun shou/tabnine-off ()
  ...
  (interactive)
  (setq-local ((company-backends (remove 'company-tabnine company-backends)))))
...
(use-package org-roam
  ...
  ((org-mode . org-roam-mode)
   (emacs-startup . org-roam--build-cache-async))
