...
(when (eq system-type 'gnu/linux)
  (setq shou/font-height 130)
  (setq shou/mono-font "Fira Code")
  (setq shou/var-font "Spectral"))

(when (eq system-type 'darwin)
  (setq shou/font-height 150)
  (setq shou/mono-font "Fira Code")
  (setq shou/var-font "Charter"))

(set-face-attribute 'default nil :family shou/mono-font :height shou/font-height)
(set-face-attribute 'variable-pitch nil :family shou/var-font :height shou/font-height)
#+END_SRC
...
(use-package mixed-pitch
  ...
  (set-face-attribute 'default nil :family "Fira Code" :height shou/font-height)
  (set-face-attribute 'variable-pitch nil :family "Charter" :height shou/font-height)
  )
#+end_src
