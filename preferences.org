...
prioritize =lsp-mode=’s find-definition function if it works,
...
#+begin_src emacs-lisp
(use-package copilot
  ;; :elpaca (:host github :repo "raymond-w-ko/copilot.el" :files ("dist" "*.el"))
  ...
  (defun shou/copilot-disable-predicate ()
    (or
     ...
     (string-match-p "\\(?:secret\\|cred\\|hidden\\|private|auth\\)"
...
(use-package lean4-mode
  :elpaca (:host github :repo "leanprover/lean4-mode" :files ("*.el" "data")))
#+end_src
...
For rust-related compile mode regexp alist, etc.

#+begin_src emacs-lisp
(use-package rust-compile
  :after rust-ts-mode
  :demand t
  :elpaca (rust-mode :files ("rust-compile.el")))
#+end_src
