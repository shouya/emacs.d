...
(add-hook 'emacs-startup-hook
	  (lambda ()
            (set-frame-font "JetBrains Mono:style=Light")
...
(cl-loop for (script font) in
         '((han "Noto Sans CJK TC DemiLight" :weight 'demilight)
           (kana "Noto Sans CJK JP DemiLight" :weight 'demilight)
           (hangul "Noto Sans CJK KR DemiLight" :weight 'demilight)
           (phonetic "Noto Sans")
